...
(function() {
	...
	max = 7;
	particles = 200;
	colors = ["111, 116, 93", "165, 160, 123", "9, 40, 54", "244, 241, 234"];
...
var secCanvas = document.getElementById("bg");
var secContext = canvas.getContext("2d");
secContext.fillText("Of Soldier Blood", 5, 20);
secContext.fillStyle = "White";
secContext.font = "20px Times New Roman";
